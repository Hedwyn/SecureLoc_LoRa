 ...
 */
 ...
 const uint8_t ANCHOR_ID[] =  {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01};
 ...
 */
 ...
 const uint8_t ROBOT_ID[] =  {0x00, 0x01, 0x02, 0x03, 0x00, 0x01, 0x02, 0x03};
...
uint8_t CheckDistance( void )
{
    ...
    if( RngResultIndex > 0 )
    {
        ...
        if (median < 10000)
        {
            ...
            /* sending distance, timestamps and rssi to serial port */
            printf("*");
            for (int i = 0; i < 8; i++) 
            {
                printf("%02x",ANCHOR_ID[i]);
            }
            printf("|");
            for (int i = 0; i < 8; i++) 
            {
                printf("%02x",ROBOT_ID[i]);
            }
            printf("|%f|%f|%f|%f|%f|%f|%f|%f|%f|%d#\n",displayRange,t0,t1,t2,t3,t4,t5,t6,t7,Eeprom.EepromData.DemoSettings.RssiValue);

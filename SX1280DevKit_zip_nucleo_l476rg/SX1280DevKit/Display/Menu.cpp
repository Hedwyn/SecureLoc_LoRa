...
bool newMes = false; // notifies that a new ranging should be triggered
/*!
...
void MenuInit( void )
{
    ...
    timer.attach(&localize,LOCALIZATION_PERIOD);
    ...
    else if( ( graphObjectTouched != 0xFF ) || ( refresh == true ) )
    {
        switch( CurrentPage )
        {
            ...
            case PAGE_RANGING_MASTER:
                ...
                else if( graphObjectTouched == RNG_MST_SCR || newMes)
                {
